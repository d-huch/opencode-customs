...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in OpenCode Customs zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in OpenCode Customs zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in OpenCode Customs zu nutzen.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor OpenCode Customs einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "OpenCode Customs konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann OpenCode Customs erneut.",
  ...
  "toast.update.description": "Eine neue Version von OpenCode Customs ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: OpenCode Customs unterstützt noch keine MCP-Authentifizierung.',
  ...
  "status.popover.tab.repositoryMap": "Karte",
  ...
  "status.popover.repositoryMap.status.complete": "Bereit",
  "status.popover.repositoryMap.status.truncated": "Teilweise",
  "status.popover.repositoryMap.status.unavailable": "Nicht verfügbar",
  "status.popover.repositoryMap.files": "Dateien",
  "status.popover.repositoryMap.areas": "Bereiche",
  "status.popover.repositoryMap.symbols": "Symbole",
  "status.popover.repositoryMap.links": "Verknüpfungen",
  "status.popover.repositoryMap.reindex": "Neu indizieren",
  "status.popover.repositoryMap.diagnostics": "Live-Diagnose",
  "status.popover.repositoryMap.diagnosticsDescription": "Repository-Routing und LSP-Aktivität anzeigen",
  "status.popover.repositoryMap.diagnosticsEmpty": "Diagnose aktivieren und dann eine Anfrage senden.",
  ...
  "sidebar.gettingStarted.line1": "OpenCode Customs enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für OpenCode Customs ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie OpenCode Customs auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob OpenCode Customs dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von OpenCode Customs anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von OpenCode Customs automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Die aktuelle Version von OpenCode Customs wird verwendet.",
  ...
  "desktop.menu.ariaLabel": "OpenCode Customs-Menü",
  ...
  "desktop.recovery.loadFailed": "OpenCode Customs konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das OpenCode Customs-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "OpenCode Customs reagiert nicht",
  ...
  "help.tabs.introduction": "OpenCode Customs Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
