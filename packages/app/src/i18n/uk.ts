export const dict = {
  ...
  "turnInspector.phase.cache_restore": "Відновлення кешу LM Studio",
  ...
  "settings.models.context.label": "Ліміт контексту",
  ...
  "settings.models.chatContext.label": "Контекст чатів",
