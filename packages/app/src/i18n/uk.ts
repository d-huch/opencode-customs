export const dict = {
  ...
  "settings.general.voice.speakResponses.description":
    "Починати озвучення завершених речень через локальний TTS-бекенд у Docker, поки агент ще генерує відповідь",
  ...
  "settings.general.voice.test.title": "Перевірити локальний голос",
  "settings.general.voice.test.description": "Прослухати тестову фразу та виміряти затримку локального синтезу",
