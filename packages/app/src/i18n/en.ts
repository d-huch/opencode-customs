export const dict = {
  ...
  "settings.general.voice.speakResponses.description":
    "Start reading complete sentences while the assistant is still generating through the local Docker TTS backend",
  ...
  "settings.general.voice.test.title": "Test local voice",
  "settings.general.voice.test.description": "Play a test phrase and measure local synthesis latency",
