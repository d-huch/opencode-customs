...
export const resolve = Effect.fn("SessionTools.resolve")(function* (input: {
      ...
      execute(args, options) {
        return run.promise(
          Effect.gen(function* () {
            ...
            yield* input.processor.beginToolCall(options.toolCallId, item.id, args)
  ...
  if (input.toolIDs && !input.includeMcp) return tools
      ...
      execute(args, opts) {
        return run.promise(
          Effect.gen(function* () {
            ...
            yield* input.processor.beginToolCall(opts.toolCallId)
