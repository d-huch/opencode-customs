...
describe("websearch provider", () => {
  ...
  test("is enabled for OpenCode providers, LM Studio, or explicit websearch provider flags", () => {
    ...
    expect(webSearchEnabled(ProviderV2.ID.make("lmstudio"), { exa: false, parallel: false })).toBe(true)
