export const dict: Record<string, string> = {
  ...
  "ui.sessionTurn.status.providerWait": "LM Studio · очікування провайдера · {{seconds}} с",
  "ui.sessionTurn.status.cacheInitialization": "LM Studio · ініціалізація кешу контексту · {{seconds}} с",
  "ui.sessionTurn.status.verifying": "Перевірка змін",
  "ui.sessionTurn.status.repairing": "Виправлення після перевірки",
  "ui.sessionTurn.status.verified": "Перевірку пройдено",
  "ui.sessionTurn.status.model": "Модель: {{model}}",
  ...
  "ui.tool.websearch.searching": "Шукає",
  "ui.tool.websearch.reading": "Читає джерела",
  "ui.tool.websearch.waitingUser": "Очікує користувача",
  "ui.tool.websearch.sources": "Джерел: {{count}}",
  "ui.tool.websearch.openBrowser": "Відкрити Research Browser",
  ...
  "ui.message.speakResponse": "Озвучити відповідь",
  "ui.message.stopSpeaking": "Зупинити озвучення",
  "ui.message.duration.seconds": "{{count}}с",
  "ui.message.duration.minutesSeconds": "{{minutes}}хв {{seconds}}с",
  "ui.message.reasoning.active": "Думає… · {{duration}}",
  "ui.message.reasoning.completed": "Думав {{duration}}",
  "ui.message.reasoning.fallback": "Думки",
