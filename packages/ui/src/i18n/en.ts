export const dict: Record<string, string> = {
  ...
  "ui.sessionTurn.status.providerWait": "LM Studio · waiting for provider · {{seconds}}s",
  "ui.sessionTurn.status.cacheInitialization": "LM Studio · initializing context cache · {{seconds}}s",
  "ui.sessionTurn.status.verifying": "Verifying changes",
  "ui.sessionTurn.status.repairing": "Repairing failed checks",
  "ui.sessionTurn.status.verified": "Verification passed",
  ...
  "ui.tool.websearch.searching": "Searching",
  "ui.tool.websearch.reading": "Reading sources",
  "ui.tool.websearch.waitingUser": "Waiting for you",
  "ui.tool.websearch.sources": "{{count}} sources",
  "ui.tool.websearch.openBrowser": "Open Research Browser",
  "ui.tool.shell": "Shell",
  "ui.tool.patch": "Patch",
