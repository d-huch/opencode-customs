    ...
    return Effect.gen(function* () {
      ...
      yield* tx.run(`
        CREATE TABLE \`session_execution_checkpoint\` (
          ...
          \`state\` text NOT NULL,
          \`phase\` text DEFAULT 'classify' NOT NULL,
          \`step\` integer NOT NULL,
          \`request_message_id\` text,
          \`evidence_attempts\` integer DEFAULT 0 NOT NULL,
          \`classifier_turns\` integer DEFAULT 0 NOT NULL,
          \`rag_retrievals\` integer DEFAULT 0 NOT NULL,
          \`memory_retrievals\` integer DEFAULT 0 NOT NULL,
          \`memory_writes\` integer DEFAULT 0 NOT NULL,
          \`verification_turns\` integer DEFAULT 0 NOT NULL,
          \`critic_turns\` integer DEFAULT 0 NOT NULL,
          ...
          \`memory_context\` text,
          \`pipeline_state\` text DEFAULT '[]' NOT NULL,
