...
const createPlatform = (windowState: DesktopWindowState): Platform => {
  ...
  return {
    ...
    clearDebugLogs: () => window.api.clearDebugLogs(),
    ...
    listFishAudioVoicePresets: () => window.api.listFishAudioVoicePresets(),
    saveFishAudioVoicePreset: (input) => window.api.saveFishAudioVoicePreset(input),
    activateFishAudioVoicePreset: (id) => window.api.activateFishAudioVoicePreset(id),
    deleteFishAudioVoicePreset: (id) => window.api.deleteFishAudioVoicePreset(id),
    ...
    getNemotronVoiceStatus: () => window.api.getNemotronVoiceStatus(),
    configureNemotronVoice: (input) => window.api.configureNemotronVoice(input),
    installNemotronVoice: () => window.api.installNemotronVoice(),
    startNemotronVoice: () => window.api.startNemotronVoice(),
    stopNemotronVoice: () => window.api.stopNemotronVoice(),
    beginNemotronVoice: (input) => window.api.beginNemotronVoice(input),
    appendNemotronVoice: (input) => window.api.appendNemotronVoice(input),
    commitNemotronVoice: (requestID) => window.api.commitNemotronVoice(requestID),
    cancelNemotronVoice: (requestID) => window.api.cancelNemotronVoice(requestID),
    onNemotronVoiceEvent: (callback) => window.api.onNemotronVoiceEvent(callback),
    ...
    getGoogleCompanionStatus: () => window.api.getGoogleCompanionStatus(),
    importGoogleOAuthClient: () => window.api.importGoogleOAuthClient(),
    connectGoogleCompanion: (writeScopes) => window.api.connectGoogleCompanion(writeScopes),
    testGoogleCompanion: () => window.api.testGoogleCompanion(),
    disconnectGoogleCompanion: () => window.api.disconnectGoogleCompanion(),
    getAvatarBridgeStatus: () => window.api.getAvatarBridgeStatus(),
    routeAvatarSpeech: (sessionID, text) => window.api.routeAvatarSpeech(sessionID, text),
    selectAvatarModel: () => window.api.selectAvatarModel(),
    getAvatarModel: () => window.api.getAvatarModel(),
    clearAvatarModel: () => window.api.clearAvatarModel(),
