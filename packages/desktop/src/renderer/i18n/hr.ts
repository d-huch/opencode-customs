export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije OpenCode Customs. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
