export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse OpenCode Customs uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCode Customs'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
