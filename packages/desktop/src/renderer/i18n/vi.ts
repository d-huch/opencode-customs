export const dict = {
  ...
  "desktop.updater.none.message": "Bạn đang sử dụng phiên bản mới nhất của OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Phiên bản {{version}} của OpenCode Customs đã được tải xuống, bạn có muốn cài đặt và khởi chạy lại không?",
