export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av OpenCode Customs har laddats ned. Vill du installera den och starta om programmet?",
