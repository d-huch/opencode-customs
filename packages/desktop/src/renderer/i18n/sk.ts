export const dict = {
  ...
  "desktop.updater.none.message": "Používate najnovšiu verziu OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzia {{version}} OpenCode Customs bola stiahnutá. Chcete ju nainštalovať a reštartovať?",
