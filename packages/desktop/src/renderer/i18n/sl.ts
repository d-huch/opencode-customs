export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} OpenCode Customs je bila prenesena, jo želite namestiti in znova zagnati?",
