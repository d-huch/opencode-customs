export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCode Customs versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
