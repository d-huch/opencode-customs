export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} OpenCode Customs a fost descărcată. Vrei să o instalezi și să repornești?",
