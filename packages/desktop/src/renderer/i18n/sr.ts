export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од OpenCode Customs је преузета, да ли желите да је инсталирате и поново покренете?",
