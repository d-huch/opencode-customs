export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon OpenCode Customs ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCode Customsning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
