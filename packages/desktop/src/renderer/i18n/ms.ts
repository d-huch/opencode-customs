export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} OpenCode Customs telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
