export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i OpenCode Customs është shkarkuar, dëshironi ta instaloni dhe rinisni?",
