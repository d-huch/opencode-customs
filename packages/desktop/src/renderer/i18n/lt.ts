export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią OpenCode Customs versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCode Customs versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
