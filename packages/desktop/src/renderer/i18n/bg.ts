export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от OpenCode Customs е изтеглена. Искате ли да я инсталирате и рестартирате?",
