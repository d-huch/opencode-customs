export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van OpenCode Customs is gedownload. Wil je deze installeren en OpenCode Customs opnieuw starten?",
