export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} OpenCode Customs. Czy chcesz ją zainstalować i uruchomić ponownie?",
