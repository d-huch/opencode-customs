export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do OpenCode Customs foi baixada. Você gostaria de instalá-la e reiniciar?",
