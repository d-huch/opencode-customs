export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di OpenCode Customs è stata scaricata. Vuoi installarla e riavviare l'app?",
