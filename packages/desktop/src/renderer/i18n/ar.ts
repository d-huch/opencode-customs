export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من OpenCode Customs. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
