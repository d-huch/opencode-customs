export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የOpenCode Customs ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከOpenCode Customs ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
