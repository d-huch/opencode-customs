export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OpenCode Customs er lastet ned. Vil du installere den og starte på nytt?",
