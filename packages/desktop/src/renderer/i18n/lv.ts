export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko OpenCode Customs versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCode Customs versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
