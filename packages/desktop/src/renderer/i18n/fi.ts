export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo OpenCode Customsn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCode Customsn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää OpenCode Customsn uudelleen?",
