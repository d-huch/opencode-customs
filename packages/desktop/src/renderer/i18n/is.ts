export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af OpenCode Customs hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",
