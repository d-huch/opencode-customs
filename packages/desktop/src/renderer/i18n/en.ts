export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of OpenCode Customs has been downloaded, would you like to install it and relaunch?",
