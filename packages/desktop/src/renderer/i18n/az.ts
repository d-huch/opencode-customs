export const dict = {
  ...
  "desktop.updater.none.message": "Artıq OpenCode Customs-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenCode Customs-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
