export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace OpenCode Customs. Chcete ji nainstalovat a aplikaci znovu spustit?",
