export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} OpenCode Customs завантажено. Бажаєте встановити її та перезапустити?",
