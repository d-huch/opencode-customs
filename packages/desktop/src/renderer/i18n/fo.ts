export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av OpenCode Customs.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av OpenCode Customs er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
