export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'OpenCode Customs",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'OpenCode Customs. Voleu instal·lar-la i reiniciar l'aplicació?",
