...
const api: ElectronAPI = {
  ...
  getGoogleCompanionStatus: () => ipcRenderer.invoke("get-google-companion-status"),
  importGoogleOAuthClient: () => ipcRenderer.invoke("import-google-oauth-client"),
  connectGoogleCompanion: (writeScopes) => ipcRenderer.invoke("connect-google-companion", writeScopes),
  testGoogleCompanion: () => ipcRenderer.invoke("test-google-companion"),
  disconnectGoogleCompanion: () => ipcRenderer.invoke("disconnect-google-companion"),
  ...
  executeJarvisReplayFixture: (replayID) => ipcRenderer.invoke("execute-jarvis-replay-fixture", replayID),
